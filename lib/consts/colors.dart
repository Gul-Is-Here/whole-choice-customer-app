...
const Color splashColor = Color.fromARGB(255, 20, 45, 79);
const Color backgroung = Color.fromRGBO(241, 250, 238, 1);
const Color yellowColor = Color.fromARGB(255, 248, 203, 0);
